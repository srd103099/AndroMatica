...
(1, 'El Rincón Mexicano', 'Calle de los Burritos 123', 'Ciudad de México', 'México', '555-123-4567', '09:00:00', '22:00:00', NULL),
(2, 'La Trattoria Italiana', 'Via Roma 456', 'Roma', 'Italia', '333-789-0123', '11:00:00', '23:00:00', NULL),
(3, 'Sushi House', 'Calle de los Sushis 789', 'Tokio', 'Japón', '111-222-3333', '12:00:00', '23:00:00', NULL),
(4, 'El Asador Argentino', 'Avenida del Asado 234', 'Buenos Aires', 'Argentina', '444-555-6666', '17:00:00', '01:00:00', NULL),
(5, 'Le Bistro Français', 'Rue de la Gastronomie 567', 'París', 'Francia', '666-777-8888', '10:00:00', '22:00:00', NULL);


INSERT INTO CLIENTE1(id_Cliente, nombre, direccion, cuidad, pais, telefono, correoelectronico) VALUES
(1, 'Juan Pérez', 'Calle Principal 123', 'Ciudad Ejemplo', 'País Ejemplo', '1234567890', 'juanperez@example.com'),
(2, 'María García', 'Avenida Central 456', 'Otra Ciudad', 'Otro País', '9876543210', 'mariagarcia@example.com'),
(3, 'Carlos Rodríguez', 'Plaza Mayor 789', 'Ciudad Principal', 'País Principal', '5551234567', 'carlosrodriguez@example.com'),
(4, 'Laura Martínez', 'Calle de los Artistas 234', 'Ciudad Creativa', 'País Creativo', '7778889999', 'lauramartinez@example.com'),
(5, 'Pedro López', 'Paseo Costero 567', 'Ciudad Costera', 'País Costero', '3334445555', 'pedrolopez@example.com');
...
(3, 'Comida Asiática', 'Comida tradicional asiática con sabores dulces y salados', 3),
...
(1, '2024-04-15', '19:30:00', 'Entrega a domicilio', 'En preparación', 50.00, 1, 4, 2),
...
(5, '2024-04-19', '21:00:00', 'Entrega a domicilio', 'En preparación', 85.00, 5, 3, 2);
...
(5, 'Guacamole', 'Guacamole con aguacate, cebolla, cilantro, tomate y limón', 12.20,  1, 1),
...
(10, 'Tiramisú', 'Postre de mascarpone, bizcocho, café y cacao', 15.20,  2, 2),

--ASIATICO
(11, 'Sushi Roll', 'Roll de sushi con salmón, aguacate y queso crema', 25.20, 3, 3),
(12, 'Tataki de atún', 'Tataki de atún con salsa de soya y jengibre', 30.20, 3, 3),
...
(20, 'Tiradito de atún', 'Tiradito de atún con salsa de soya y jengibre', 28.50, 4, 4),

--FRANCES
(21, 'Coq au Vin', 'Pollo guisado en vino tinto con champiñones, tocino y cebolla', 25.50, 5, 5),
(22, 'Ratatouille', 'Guiso de berenjena, pimiento, calabacín y tomate con ajo y albahaca', 22.50, 5, 5),
(23, 'Quiche Lorraine', 'Tarta salada de huevo, nata y tocino', 20.50, 5, 5),
(24, 'Boeuf Bourguignon', 'Guiso de ternera en vino tinto con champiñones, cebolla y zanahoria', 30.50, 5, 5),
(25, 'Crêpes Suzette', 'Crêpes flambeadas con naranja, mantequilla y Grand Marnier', 18.50, 5, 5);
